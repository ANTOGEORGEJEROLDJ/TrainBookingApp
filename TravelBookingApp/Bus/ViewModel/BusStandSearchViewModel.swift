...
class BusStandSearchViewModel: ObservableObject {
    ...
    @Published var allTrains: [TrainModel] = [
        TrainModel(
            ...
            stops: ["Chengalpattu", "Villupuram", "Trichy", "Dindigul", "Samayanallur"]
        ),
        TrainModel(
            id: UUID(),
        ...
        TrainModel(
            ...
            stops: ["Chengalpattu", "Villupuram", "Salem", "Erode", "Tiruppur"]
        ),
        TrainModel(
            id: UUID(),
        ...
        TrainModel(
            ...
            stops: ["Valliyur", "Tenkasi", "Virudhunagar"]
        ),
        TrainModel(
            id: UUID(),
        ...
        TrainModel(
            ...
            stops: ["Villupuram", "Trichy", "Madurai"]
        ),
        TrainModel(
            id: UUID(),
            ...
            classes: ["Non AC"],
            prices: ["Non AC": 280],
            stops: ["Tuticorin", "Arumuganeri", "Vanchi Maniyachchi"]
        ),
        TrainModel(
            id: UUID(),
            ...
            stops: ["Katpadi", "Villupuram", "Ariyalur"]
        )
    ]
